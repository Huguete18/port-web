        ...
        <div>
            <form className='flex flex-col'>
                <div className='mb-6'>
                    ...
                    <input type='email' id='email' required className='bg-[#18191e] border border-[#33353f] placeholder-[#9ca2a9] text-gray-100 text-sm rounded-lg block w-full p-2.5' placeholder='username@gmail.com' />
                </div>
                <div className='mb-6'>
                ...
                <div className='mb-6'>
                    ...
                    <textarea type='text' id='subject' required className='bg-[#18191e] border border-[#33353f] placeholder-[#9ca2a9] text-gray-100 text-sm rounded-lg block w-full p-2.5' placeholder='Contact me...' />
                </div>
...
/*<button type='submit' className='bg-purple-500 hover:bg-purple-600 text-white font-medium py-2.5 px-5 rounded-lg w-full' onClick={async () => {
